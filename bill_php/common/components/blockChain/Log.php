...
class Log extends ActiveRecord
{
	...
	public static function tableName(){
		$tableName = Yii::$app->db->tablePrefix . 'block_chain_log_' . date('Y_m');
		if(!DatabaseHelper::hasTable($tableName)){
			CreateTable::BlockChainLog($tableName);
		}
		return '{{' . $tableName . '}}';
	}
	...
	public function rules(){
		return [
			[['status', 'url', 'route', 'error_info', 'posts', 'responses'], 'safe', 'on' => 'create']
		];
	}
