  ...
  <div class="fcpIndex">
    <div class="clearfix">
        ...
        <div class="fcpi__row clearfix">
          ...
          <div class="fcpi__rowR fl cellTitle">
            <div class="waiting_left wleft">
              ...
              <div class="fcpi__cell bgwihte">
                <span class="green">{{finance.invoice}}元</span>
                <span>累计收票</span>
              </div>
            </div>
            <div class="waiting_left wright">
              ...
              <div class="fcpi__cell bgwihte">
                <span class="blue">{{finance.expense}}元</span>
                <span>收票支出</span>
              </div>
            </div>
          </div>
      ...
      <!-- <div class="fcpi__box fl">
        <div class="fcpi__row clearfix">
          <div class="fcpi__rowL fl cellTitle">
            <div class="fcpi__cell" style="padding-left:20px;">
              票据资产 <span class="spanblod">{{finance.total}}元</span>
            </div>
          </div>
          <div class="fcpi__rowR fl cellTitle">
            <div class="fcpi__tiny fl">
        ...
        <div class="fcpi__row clearfix">
          ...
          <div class="fcpi__rowR fl cellTitle">
            <i class="pub_iconOran icon_blue iconfont icon-yinpiao"></i>
            <div class="fcpi__cell bgwihte">
              <span class="blue">{{finance.bank_bill}}</span>
              <span>冻结票据</span>
            </div>
          </div>
        </div>
        <div class="fcpi__row">
          <div class="fcpi__rowL fl cellTitle">
            <i class="pub_iconOran icon_green iconfont icon-jiaoyizhong"></i>
            <div class="fcpi__cell bgwihte">
              <span class="green">{{finance.transaction}}元</span>
              <span>累计转让</span>
            </div>
          </div>
          <div class="fcpi__rowR fl cellTitle">
            <i class="pub_iconOran icon_blue iconfont icon-shangpiao"></i>
            <div class="fcpi__cell bgwihte">
              <span class="blue">{{finance.commercial_bill}}</span>
              <span>累计收入</span>
            </div>
          </div>
        </div>
    ...
    <div class="clearfix tablemain">
      ...
      <div>
        ...
        <el-pagination class="table__page" layout="prev, pager, next" :total="total3" :page-size="15" @current-change="changePage3">
        </el-pagination>
      </div>
    </div>
    <getRechange :dialogtype="dialogtype" :ischaneg='change' v-on:reFlashBill="reFlashBill"></getRechange>
  </div>
</template>
<script>
import api from '../api'
