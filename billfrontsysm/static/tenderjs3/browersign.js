...
{
    var publicKey = amdminMixkey.publicKey;
    var privateKey = amdminMixkey.privateKey;
    amdminMixkey = new Buffers(privateKey + publicKey, 'hex');
    ...
    operation.uid = new Buffers(publicKey, 'hex');
...
{
    var publicKey = operatorMixkey.publicKey;
    var privateKey = operatorMixkey.privateKey;
    operatorMixkey = new Buffers(privateKey + publicKey, 'hex');
...
{
    var publicKey = adminMixkey.publicKey;
    var privateKey = adminMixkey.privateKey;
    adminMixkey = new Buffers(privateKey + publicKey, 'hex');
...
{
    var publicKey = operationMixkey.publicKey;
    var privateKey = operationMixkey.privateKey;
    operationMixkey = new Buffers(privateKey + publicKey, 'hex');
...
{
    var publicKey = bankMixkey.publicKey;
    var privateKey = bankMixkey.privateKey;
    bankMixkey = new Buffers(privateKey + publicKey, 'hex');
...
{
    // console.log(operatorMixkey, ownerPublickey, uid,  type, billId, drawer, taker, acceptor, expiration, nominalValue,billInfo);
...
billSign.prototype.signEndorseNote = function(operatorMixkey, ownerPublickKey, toPublicKey, billId)
{
    ...
    operation.owner = new Buffers(ownerPublickKey,"hex");
    if(toPublicKey != ''){
        toPublicKey = new Buffers(toPublicKey,"hex");
    }
    operation.to = toPublicKey;
